...
<head>
    ...
    $(document).ready(function() {
        $('#pp-quiz-form').submit(function(event) {
...
<body>
    ...
    <div class="content">
        <div class="container">
            <div class="ppQuiz-container"></div>
            ...
            <div class="quiz-box custom-box">
                ...
                <div class="pp-quiz1">
                    ...
                    <form id="pp-quiz-form" method="post" action="ppQuizResult.php">
    ...
    function showNextDiv2() {
        ...
        var div = document.querySelector('.pp-quiz2'); // Get reference to the div element
        div.style.display = "block";
    }
    ...
    function showNextDiv3() {
        var div = document.querySelector('.pp-quiz2'); // Get reference to the div element
        div.style.display = "none"; // Add the new class
        var div = document.querySelector('.pp-quiz3'); // Get reference to the div element
        div.style.display = "block";
    }
    ...
    function showNextDiv4() {
        var div = document.querySelector('.pp-quiz3'); // Get reference to the div element
        div.style.display = "none"; // Add the new class
        var div = document.querySelector('.pp-quiz4'); // Get reference to the div element
        div.style.display = "block";
    }
    ...
    function showNextDiv5() {
        var div = document.querySelector('.pp-quiz4'); // Get reference to the div element
        div.style.display = "none"; // Add the new class
        var div = document.querySelector('.pp-quiz5'); // Get reference to the div element
        div.style.display = "block";
    }
    ...
    function showNextDiv6() {
        var div = document.querySelector('.pp-quiz5'); // Get reference to the div element
        div.style.display = "none"; // Add the new class
        var div = document.querySelector('.pp-quiz6'); // Get reference to the div element
        div.style.display = "block";
    }
    ...
    function showNextDiv7() {
        var div = document.querySelector('.pp-quiz6'); // Get reference to the div element
        div.style.display = "none"; // Add the new class
        var div = document.querySelector('.pp-quiz7'); // Get reference to the div element
        div.style.display = "block";
    }
    ...
    function showNextDiv8() {
        var div = document.querySelector('.pp-quiz7'); // Get reference to the div element
        div.style.display = "none"; // Add the new class
        var div = document.querySelector('.pp-quiz8'); // Get reference to the div element
        div.style.display = "block";
    }
    ...
    function showNextDiv9() {
        var div = document.querySelector('.pp-quiz8'); // Get reference to the div element
        div.style.display = "none"; // Add the new class
        var div = document.querySelector('.pp-quiz9'); // Get reference to the div element
        div.style.display = "block";
    }
