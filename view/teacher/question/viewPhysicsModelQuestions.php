...
<<<<<<< HEAD
    ...
    <title>Physics Model Questions</title>
=======
    <title>Physics Model Questions</title>
...
<div class="content">
    ...
    <div class="main">
        ...
        <div id="dashboard-container">
            ...
            <b><p id="title-navigate"><span id="subject-shortcut"><a href="../teacherDashboard.php">Physics</a></span>&nbsp;&nbsp;>&nbsp;&nbsp;Model Paper</p></b>
        ...
        <div style="margin-right: 100px;">
            ...
            <table id="table">
                ...
                if(isset($_GET['view-questions'])){
                    ...
                    $questions = $viewQuestionController->viewQuestions("Physics", $_GET['topic'], "MODELQUESTION");
                    echo "<th>Physics : {$_GET['topic']} : Model Questions</th>";
...
<table id="table">
    ...
    if(isset($_GET['view-questions'])){
        ...
        if($questions){
            ...
            echo "<th>Physics : {$_GET['topic']} : Model Questions<br>No Questions to View</th>";
        }
    }else{
