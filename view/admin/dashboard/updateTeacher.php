                                    ...
                                    <div class="popup-UpdateTeacher">
                                        ...
                                        <div class="forms-div">
                                            ...
                                            <form class="UpdateTeach-form" action="<?= base_url('controller/adminController/dashboardController/updateTeacherController.php') ?>" method="POST" id="UpdateTeacher-form">
                                                ...
                                                <input type="text" name="username" id="teacher-username" class="teacher-username" >
                                                <input type="text" name="userId" id="teacher-userId" class="teacher-userId" value="<?= $_SESSION['user']['userId'] ?>" >
                             ...
                             <?php
                                    ...
                                    <div class="popup-UpdateTeacher">
                                        ...
                                        <div class="forms-div">
                                            ...
                                            <form class="UpdateTeach-form" action="<?= base_url('controller/adminController/dashboardController/updateTeacherController.php') ?>" method="POST" id="UpdateTeacher-form">
                                                <input type="text" name="fname"   id="teacher-fname" value="" >
                                                <input type="text" name="lname"   id="teacher-lname" value="" >
                                                <input type="text" name="address1" id="teacher-address1" value="">
                                                <input type="text" name="address2" id="teacher-address2" value="">
                                                <input type="text" name="number"   id="teacher-number" value="">
                                                <input type="email" name="email"   id="teacher-email" value="">
                                                <input type="text" name="username" id="teacher-username" class="teacher-username" >
                                                <input type="text" name="userId" id="teacher-userId" class="teacher-userId" value="" >
