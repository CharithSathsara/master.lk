...
<body>
        ...
        <div class="container">
            <div class="modelQuiz-container">
                ...
                <div class="result-box custom-box ">
                    ...
                    <a href="../../../view/student/modelQuiz/modelQuiz.php"><button type="button" class="quiz-btn">Try
                            Again</button></a>
    ...
    <!-- <form method="post" id="modelQuizDetailForm"
        action="../../../controller/studentController/quizController/modelQuizController.php">
        <input type="hidden" name="modelQuizUser" value="" />
    </form>

    <script>
    // Send an AJAX request to submit the form
    $(document).ready(function() {
        var form = $("#modelQuizDetailForm");
