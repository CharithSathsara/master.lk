...
?>
        ...
        <div class="contentecreator-container">
            ...
            <div class="select">
                ...
                <form action="" class="view-form" method="POST">
                    ...
                    <div class="selectTopic">
                        <div class="selecttopic">
                            <label class="topicLabel">Select Lessons:</label>
                            <select id="selecttopic" name="selectTopic">
                                <option value="Organic Introduction">Organic Chemistry</option>
                                <option value="IUPAC Nomenclature">Inorganic Chemistry</option>
                                <option value="S Block">Electronics</option>
                                <option value="P Block">Mechanics</option>
                            </select>
                    ...
                    <div class="add-btns">
                        <ul class="btn-list">
                            <li><a href="addTheoryQuestions.php" class="add-btn-topic" id="add-btn-topic">Add Questions</a></li>
            ...
            <table class="content-table">
                ...
                <tr class="sectionTable">
                    <td class="sectionRow">Question No 01</td>
                    <td class="row-icon"><a href="../../view/contentcreator/updateTheoryQuestions.php"><img
                ...
                <tr class="sectionTable">
                    <td class="sectionRow">Question No 02</td>
                    <td class="row-icon"><a href="../../view/contentcreator/updateTheoryQuestions.php"><img
                                src="../../public/icons/edit.png" alt="edit" id="editImg" width="16px"
                                height="16px"></a>
                    </td>
    ...
    <div id="setDeleteTheoryPopup">
        <div id="popup2">
            ...
            <form action="" class="deleteTheory-form" method="POST">
