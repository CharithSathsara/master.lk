...
<head>
    ...
    $(document).ready(function() {
        $('#pp-quiz-form').submit(function(event) {
            ...
            $.ajax({
                type: 'POST',
                url: '../../../view/student/ppQuiz/loadQuestions.php',
                data: formData,
...
<body>
    ...
    //     $.ajax({
    //         url: '../../../view/student/ppQuiz/loadResult.php', // the URL of the server-side script that retrieves data from the database
    //         type: 'GET',
    //         // async: false,
